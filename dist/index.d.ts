...
export declare interface EnumChangeContext {
...
/** @public */
export declare function JsonValidator({ open, onOpenChange, schema, autoFocus, }: JsonValidatorProps): JSX.Element;
...
/** @public */
export declare function SchemaInferencer({ open, onOpenChange, onSchemaInferred, autoFocus, }: SchemaInferencerProps): JSX.Element;
