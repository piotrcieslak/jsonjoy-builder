...
function getEditorType(schema) {
    ...
    return withObjectSchema(schema, (s)=>s.type || "object", "object");
}
export { asObjectSchema, baseSchema, getEditorType, getSchemaDescription, isAllOfSchema, isAnyOfSchema, isBooleanSchema, isObjectSchema, isOneOfSchema, jsonSchemaType, withObjectSchema };
