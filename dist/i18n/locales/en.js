const en = {
    ...
    fieldNameRegexHelp: "Allows any property whose name matches this regular expression. Matching properties must follow this field schema. Use ^ and $ to match the whole name.",
    ...
    propertyNameRegexDescription: "Allows and validates properties whose names match this regular expression.",
    ...
    additionalPropertiesTooltip: "Controls whether properties not defined in 'properties' or 'patternProperties' are allowed",
