const uk = {
    ...
    fieldNameRegexHelp: "Дозволяє будь-яку властивість, назва якої збігається з цим регулярним виразом. Властивості, що збігаються, мають відповідати цій схемі поля. Використовуйте ^ і $, щоб перевіряти назву повністю.",
    ...
    propertyNameRegexDescription: "Дозволяє й перевіряє властивості, назви яких збігаються з цим регулярним виразом.",
    ...
    additionalPropertiesTooltip: "Контролює, чи дозволені властивості, не визначені в 'properties' або 'patternProperties'",
