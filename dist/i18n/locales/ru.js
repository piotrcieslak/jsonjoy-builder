const ru = {
    ...
    fieldNameRegexHelp: "Разрешает любое свойство, имя которого совпадает с этим регулярным выражением. Совпавшие свойства должны соответствовать этой схеме поля. Используйте ^ и $, чтобы проверять имя целиком.",
    ...
    propertyNameRegexDescription: "Разрешает и проверяет свойства, имена которых совпадают с этим регулярным выражением.",
    ...
    additionalPropertiesTooltip: "Определяет, разрешены ли свойства, не указанные в 'properties' или 'patternProperties'",
