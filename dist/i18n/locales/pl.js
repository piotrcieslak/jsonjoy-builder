const pl = {
    ...
    fieldNameRegexHelp: "Dopuszcza każdą właściwość, której nazwa pasuje do tego wyrażenia regularnego. Pasujące właściwości muszą spełniać ten schemat pola. Użyj ^ i $, aby dopasować całą nazwę.",
    ...
    propertyNameRegexDescription: "Dopuszcza i waliduje właściwości, których nazwa pasuje do tego wyrażenia regularnego.",
    ...
    arrayValidationErrorContainsMinMax: "'minContains' nie może być większe niż 'maxContains'.",
    ...
    numberValidationErrorBothExclusiveAndInclusiveMin: "Nie można jednocześnie ustawić 'exclusiveMinimum' i 'minimum'.",
    numberValidationErrorBothExclusiveAndInclusiveMax: "Nie można jednocześnie ustawić 'exclusiveMaximum' i 'maximum'.",
    numberValidationErrorEnumOutOfRange: "Wartości enum muszą być w zdefiniowanym zakresie.",
    objectPropertiesNone: "Nie zdefiniowano właściwości",
    objectValidationErrorMinMax: "'minProperties' nie może być większe niż 'maxProperties'.",
    additionalPropertiesAllow: "Zezwalaj na dodatkowe właściwości",
    additionalPropertiesForbid: "Zabroń dodatkowych właściwości",
    additionalPropertiesTooltip: "Kontroluje czy właściwości niezdefiniowane w 'properties' lub 'patternProperties' są dozwolone",
    ...
    stringValidationErrorLengthRange: "'Minimalna długość' nie może być większa niż 'Maksymalna długość'.",
    ...
    inferrerDescription: "Wklej swój dokument JSON poniżej, aby wygenerować z niego schemat.",
    ...
    validatorDescription: "Wklej swój dokument JSON, aby zwalidować go względem bieżącego schematu. Walidacja następuje automatycznie podczas pisania.",
