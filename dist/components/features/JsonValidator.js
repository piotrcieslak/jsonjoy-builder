...
function JsonValidator({ open, onOpenChange, schema, autoFocus = true }) {
                    ...
                    children: [
                        ...
                        !validationResult.valid && validationResult.errors && validationResult.errors.length > 0 && /*#__PURE__*/ jsxs("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ jsx("ul", {
                                    className: "space-y-2",
                                    children: validationResult.errors.map((error)=>/*#__PURE__*/ jsx("button", {
                                            type: "button",
                                        ...
                                        }, `error-${error.path}-${error.message}-${error.line ?? "na"}-${error.column ?? "na"}`))
                                })
                            ]
                        })
                    ]
