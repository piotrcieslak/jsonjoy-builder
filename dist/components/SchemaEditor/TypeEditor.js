...
import { getEditorType } from "../../types/jsonSchema.js";
...
const CombinatorEditor = /*#__PURE__*/ lazy(()=>import("./types/CombinatorEditor.js"));
const TypeEditor = ({ schema, validationNode, onChange, schemaKey, onAddEnum, onDeleteEnum, depth = 0, readOnly = false })=>{
    ...
    return /*#__PURE__*/ jsxs(Suspense, {
        ...
        children: [
            ...
            ("anyOf" === type || "oneOf" === type || "allOf" === type) && /*#__PURE__*/ jsx(CombinatorEditor, {
                readOnly: readOnly,
                schema: schema,
                onChange: onChange,
                schemaKey: schemaKey,
...
export default SchemaEditor_TypeEditor;
