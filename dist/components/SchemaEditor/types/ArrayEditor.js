...
import { asObjectSchema, isBooleanSchema, withObjectSchema } from "../../../types/jsonSchema.js";
import TypeDropdown from "../TypeDropdown.js";
import TypeEditor from "../TypeEditor.js";
const ArrayEditor = ({ schema, readOnly = false, validationNode, onChange, schemaKey, onAddEnum, onDeleteEnum, depth = 0 })=>{
    ...
    const itemSchemaKey = schemaKey ? `${schemaKey}[]` : void 0;
...
export default types_ArrayEditor;
