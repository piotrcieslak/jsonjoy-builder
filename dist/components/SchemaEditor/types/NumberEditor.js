...
const NumberEditor = ({ schema, validationNode, onChange, schemaKey, onAddEnum, onDeleteEnum, integer = false, readOnly = false })=>{
    ...
    const applyEnumValues = (values)=>{
        if (values.length > 0) return void handleValidationChange("enum", values);
        handleValidationChange("enum", void 0);
    };
...
export default types_NumberEditor;
